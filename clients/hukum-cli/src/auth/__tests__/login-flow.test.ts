...
// `hukum login` (interactive device flow) migrated to §7: after the device
...
const signedInUser = userWith("u1", "ada@hukum.ai", "Ada");
...
const authorizedDevice: DeviceAuthorizationResult = {
  ...
  verificationUriComplete: "https://app.hukum.ai/device?code=ABCD-1234",
  intervalSeconds: 0,
