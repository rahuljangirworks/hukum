...
// Cross-process handoff file `hukum host update` writes so the host
...
// repo/package graph from `hukum-host/`) at
// `hukum-host/src/paths.ts::hostHomeDir`, and shape-compatible with
