...
export const DOCTOR_ISSUE_CODES = {
  ...
  // macOS: the label is registered by Hukum Desktop via SMAppService, not
  ...
  // of `hukum host doctor` for every user whose home is on a network
  // filesystem.
  ...
  // Windows-only: ~/.hukum/cli/credentials inherits permissive
