...
import { isProcessStartIdentity } from "@hukum/protocol/host/lifecycle";
import {
...
// Cross-invocation staging for registry archive downloads (hukum#585,
// #586, #588).
//
...
// the cli-lock, and nothing stops a user running `hukum host install` in
