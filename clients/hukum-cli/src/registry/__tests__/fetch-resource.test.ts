...
beforeEach(() => {
  workDir = mkdtempSync(join(tmpdir(), "hukum-fetch-resource-"));
...
describe("downloadToFile resume and integrity policy", () => {
  ...
  it(
    ...
    async () => {
      // The cross-invocation case (hukum#588): a fresh downloader sees
  ...
  it(
    ...
    async () => {
      ...
      // took the partial with it - hukum#585's "downloaded 231 MB of
