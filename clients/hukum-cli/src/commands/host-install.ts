...
// `hukum host install <version|latest>` - registry path (NP-4) /
...
// `hukum host install` end-to-end stands up the host without
// needing Desktop or a separate `hukum host service install` step. The
