...
// `hukum host available --json` envelope (below) nests assets under
...
const AVAILABLE_ASSET: HostPlatformAsset = {
  ...
  url: "https://github.com/hukumai/hukum/releases/download/host-v1.2.0/hukum-host-macos-arm64.tar.gz",
  sizeBytes: 123,
  sha256: "a".repeat(64),
  signatureUrl:
    "https://github.com/hukumai/hukum/releases/download/host-v1.2.0/hukum-host-macos-arm64.tar.gz.minisig",
...
describe("buildHostAvailableListing", () => {
  it("hides prerelease host versions by default", () => {
    const listing = buildHostAvailableListing({
      ...
      manifestUrl:
        "https://github.com/hukumai/hukum/releases/download/released-host-versions/versions.json",
...
// `clients/hukum-cli/` internals at runtime; this copy exists solely to
...
const OTHER_PLATFORM_ASSET: HostPlatformAsset = {
  ...AVAILABLE_ASSET,
  url: "https://github.com/hukumai/hukum/releases/download/host-v1.2.0/hukum-host-linux-x64.tar.gz",
  sha256: "b".repeat(64),
  signatureUrl:
    "https://github.com/hukumai/hukum/releases/download/host-v1.2.0/hukum-host-linux-x64.tar.gz.minisig",
};
