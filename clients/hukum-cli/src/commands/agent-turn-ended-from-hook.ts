...
/**
 * `hukum agent turn-ended-from-hook --provider <provider>` - invoked by
 ...
 * `HUKUM_EPIC_ID` / `HUKUM_AGENT_ID` (e.g. claude launched standalone
 * outside Hukum), an unknown provider, or a host-not-running condition
