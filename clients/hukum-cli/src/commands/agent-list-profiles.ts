import { formatAgentProviderProfilesResponse } from "@hukum/protocol/agent/agent-profile-format";
import {
...
/**
 * `hukum agent list-profiles <harness>` - the provider profiles available
