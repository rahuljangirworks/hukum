import { formatAgentProviderProfileRateLimitsResponse } from "@hukum/protocol/agent/agent-profile-format";
import {
...
/**
 * `hukum agent profile-rate-limits <harness> --profile <ambient|id>` - a
