...
// `hukum cli mark-source` - internal, hidden command. Package-manager
...
// owned by the package manager so `hukum cli upgrade` routes to the
    ...
    if (args.source === "manual") {
      ...
      throw cliError({
        ...
        message:
          ...
          "To re-anchor a manually installed CLI, run 'hukum cli re-anchor --binary-path <path> --installed-version <version>'.",
