...
import {
  getHukumStreamingHighlighter,
  resetHukumStreamingHighlighterForTests,
} from "@/markdown/hukum-streaming-highlighter";
...
function highlighter(): StreamingHighlighter {
  return getHukumStreamingHighlighter();
}
...
describe("Hukum StreamingHighlighter adapter", () => {
...
describe("useThrottledHighlight + Hukum adapter", () => {
...
describe("HukumStreamingHighlighter boot retry", () => {
  afterEach(() => {
    resetHukumStreamingHighlighterForTests();
  });
