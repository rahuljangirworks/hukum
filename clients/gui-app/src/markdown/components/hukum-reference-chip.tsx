...
interface HukumReferenceChipProps {
...
/**
 * Shared inline chip for the legacy `<hukum-*>` reference components. Mirrors
 * the visual treatment of the prior `HukumFileReference` chip: a small inline
 ...
 */
export function HukumReferenceChip(props: HukumReferenceChipProps) {
