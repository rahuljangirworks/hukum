...
import type {
  RpcSchedulingMode,
  RpcSchedulingPolicy,
} from "@hukum-clients/shared/host-client/rpc-scheduling-policy";
import { hostRpcRegistry, type HostRpcRegistry } from "@hukum/protocol/host";
import type { ProviderManagedInstallState } from "@hukum/protocol/host/provider-schemas";
...
export const HOST_METHOD_POLL_TABLE = {
  ...
  "agentQuestions.list": { ...LATEST_SCHEDULING, poll: { kind: "fixed", intervalMs: 2000 } },
  "agentQuestions.answer": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "agentQuestions.dismiss": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "backgroundJobs.list": { ...LATEST_SCHEDULING, poll: { kind: "fixed", intervalMs: 2000 } },
  "backgroundJobs.status": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "backgroundJobs.cancel": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "agent.spawn": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "providers.updateBundled": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "providers.addApiKey": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "providers.removeApiKey": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "providers.listApiKeys": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.scaffold": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.connect": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  ...
  "brain.getGraph": { mode: "fifo", joinResponseTimeoutMs: null, poll: { kind: "fixed", intervalMs: 5000 } },
  ...
  "brain.adapters.list": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.adapters.create": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.mounts.getRegistry": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.mounts.registerWorkspace": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.mounts.attachSkill": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.mounts.inspect": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.mounts.reconcile": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.mounts.detachSkill": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.getEvidence": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.listCandidates": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.listEpisodes": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.listImprovements": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.proposeSkill": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.promoteSkill": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.evolution.rollbackSkill": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
  "brain.policy.decideAction": { mode: "fifo", joinResponseTimeoutMs: null, poll: null },
