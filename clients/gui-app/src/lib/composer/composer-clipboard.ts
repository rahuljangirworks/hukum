...
const CLIPBOARD_SCHEMA = "hukum.composer-content";
const CLIPBOARD_VERSION = 1;
const COMPOSER_CONTENT_HTML_ATTR = "data-hukum-composer-content";

const COMPOSER_CLIPBOARD_MIME = "application/x-hukum-composer+json";
