...
function buildHost(): MockRunnerHost {
  return new MockRunnerHost({
    signInUrl: "https://platform.hukum.ai?redirect_uri=hukum%3A%2F%2Fauth",
...
const HUKUM_APP_TEST_TIMEOUT_MS = 30_000;
