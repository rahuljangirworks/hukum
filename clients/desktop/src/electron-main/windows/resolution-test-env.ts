export const RESOLUTION_TEST_USER_DATA_DIR_ENV =
  "HUKUM_RESOLUTION_TEST_USER_DATA_DIR";

const WINDOW_BOUNDS_ENV = "HUKUM_RESOLUTION_TEST_WINDOW_BOUNDS";
const DISPLAY_BOUNDS_ENV = "HUKUM_RESOLUTION_TEST_DISPLAY_BOUNDS";
const DISPLAY_SCALE_FACTOR_ENV = "HUKUM_RESOLUTION_TEST_DISPLAY_SCALE_FACTOR";
const DISABLE_MAXIMIZE_ENV = "HUKUM_RESOLUTION_TEST_DISABLE_MAXIMIZE";
const USE_BUILT_RENDERER_ENV = "HUKUM_RESOLUTION_TEST_USE_BUILT_RENDERER";
