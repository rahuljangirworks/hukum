 ...
 * authoritative gate; the Hukum Host recognizes this code only so callers can
 ...
 *
 * Lives in @hukum/protocol so server, Hukum Host, and clients can all reach
 * the same shape (the lint boundary blocks `@hukumai/*` from clients).
 */
